-- ============================================
-- DIRECT FIX FOR validate_onboarding_step FUNCTION
...
BEGIN
  ...
  -- Step 2: Services validation - COMPLETELY FIXED
  IF p_step = 2 THEN
    ...
    -- CRITICAL FIX: Use proper join - service_types.category_id -> service_categories.id -> service_categories.company_id
    SELECT COUNT(*) INTO v_service_count
...
SELECT '✅ Function completely fixed and tested!' as result;
