...
const Messages = () => {
  ...
  const loadMessageThreads = async () => {
    try {
      setLoading(true);
      const threadData = await MessagingService.getMessageThreads(user.company_id, user.id);
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      if (selectedThread.type === 'request') {
        recipientInfo = await MessagingService.getCustomerForRequest(selectedThread.context_id);
        ...
        recipientInfo = await MessagingService.getCustomerForJob(selectedThread.context_id);
  ...
  return (
    <div className="space-y-6">
      <PageHeader 
        title="Messages" 
        subtitle="Communicate with customers about requests and jobs"
      />
            ...
            <div className="overflow-y-auto" style={{ height: 'calc(100% - 60px)' }}>
              {threads.length === 0 ? (
                <div className="p-4 text-center text-gray-500">
                  ...
                  <p className="text-xs mt-1">Messages will appear when you communicate with customers</p>
                </div>
              ) : (
                threads.map((thread) => (
                  <button
          ...
          {selectedThread ? (
            <div className="flex-1 flex flex-col">
              ...
              <div className="p-4 border-b border-gray-200 bg-white">
                ...
                <p className="text-sm text-gray-600 mt-1">Customer: {selectedThread.customer_name}</p>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              Messages are organized by marketplace requests and work orders. You can only message customers 
              who have submitted requests you responded to or are assigned to your jobs.
            </p>
          </div>
        </div>
      </div>
