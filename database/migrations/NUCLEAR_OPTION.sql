-- ============================================================================
-- NUCLEAR OPTION: Complete RPC function reset
-- ============================================================================
-- This completely removes and recreates all invoice RPC functions
-- Run this in Supabase SQL Editor

-- Step 1: Drop ALL functions with any signature
...
-- Step 2: Wait a moment (comment this out if running in batch)
-- SELECT pg_sleep(1);

-- Step 3: Create the simple get_filtered_invoices function
...
-- Step 5: Create update status function
...
-- Done! All functions recreated from scratch
